/*
  # Fix authentication setup with proper cleanup and error handling
  
  1. Changes
    - Remove existing users and their profiles
    - Create new users with proper credentials
    - Create corresponding profiles with correct roles
    - Handle cleanup and creation in correct order
    - Add proper error handling for existing records
*/
